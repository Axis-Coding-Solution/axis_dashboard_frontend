...
import { COMPANIE_MUTATION_KEY, COMPANIE_QUERY_KEY, useDeleteCompany, useGetAllCompanyData } from '../../../api/hooks/companies/index.ts';
...
const Companies = () => {
  ...
  const { data } = useGetAllCompanyData();
   ...
   const queryClient = useQueryClient();
    async function deleteDepartment() {
       try {
         ...
         queryClient.invalidateQueries({ queryKey: [COMPANIE_MUTATION_KEY] });
         if (response?.success) {
        ...
        <div className="d-flex">
          ...
          <div>
            <h2 className="table-avatar d-flex align-items-center table-padding">
              <Link to="/company-details" className="company-img"><img src={record.profileImage} alt="UserImage" /></Link>
              <Link to="/company-details" className="profile-split">{record.companyName}</Link>
            </h2>
          </div>
        </div>
      ),
        ...
        <div className="dropdown dropdown-action text-end">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            <Link
              ...
              onClick={() => setSelectedCompanyId(record._id)}
            >
  ...
  return (
    ...
    <div className="page-wrapper">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-8 float-end ms-auto">
              <div className="d-flex title-head">
                ...
                <Link to="#" className="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_company"><i className="la la-plus-circle" onClick={() => setFieldInputs(null)}/> Add Company</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <CompaniesModal  id={selectedCompanyId} setSelectedCompanyId={setSelectedCompanyId}/>
      <DeleteModal
        isOpen={deleteModal}
