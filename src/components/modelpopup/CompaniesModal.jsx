...
const CompaniesModal = ({ id, setSelectedCompanyId }) => {
  ...
  const options = {
    ...
    ownerOptions: [
      { value: 'select', label: 'Select' },
      { value: '679b34da05da92b290d7bb2f', label: 'test' },
      { value: 'french', label: 'French' }
    ]
  };
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          <div className="input-block mb-3">
                            ...
                            <input className="form-control" type="text" name="companyName" value={formData?.companyName} onChange={handleInputChange} />
                          </div>
                        </div>
                        <div className="col-md-6">
                          <div className="input-block mb-3">
                        ...
                        <div className="col-md-6">
                          <div className="input-block mb-3">
                            ...
                            <Select options={options.ownerOptions} placeholder="Select Options" name="owner" onChange={handleSelectChange} />
              ...
              <form onSubmit={handleSubmit(onSubmitHandler)} action="/company">
                <div className="contact-input-set">
                  ...
                  <div className="col-lg-12 text-end form-wizard-button">
                    ...
                    <button className="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#success_msg">Save </button>
                  </div>			
                </div>
              </form>
            </fieldset> */}
